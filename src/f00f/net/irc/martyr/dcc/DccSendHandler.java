...
public class DccSendHandler extends Thread
{
		...
		throws IOException
	{
		...
		ALS.alDebugPrint("DccSendHandler: handleDcc in thread: " + Thread.currentThread().getName());
		...
		ALS.alDebugPrint("DccSendHandler: Done writing file: " + filename);
		ALS.alDebugPrint("DccSendHandler: Total bytes: " + totalin);
		socket.close();
	}
