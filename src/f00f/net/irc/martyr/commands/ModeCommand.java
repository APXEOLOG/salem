...
public class ModeCommand implements InCommand, OutCommand
{
	...
	public static void registerMode( Map<Character,Mode> modes, Mode mode )
	{
		...
		{
			ALS.alDebugPrint("ModeCommand: Warning: Two modes with same letter: " +
	...
	public InCommand parse( String prefix, String identifier, String params )
	{
		...
		//ALS.alDebugPrint("ModeCommand: Prefix: " + prefix + " str: " + str
		//	+ " total: " + params);
		...
		for( int i = 0; i < stop; ++i )
		{
			...
			else
			{
				...
				if( mode == null )
				{
					...
					ALS.alDebugPrint("ModeCommand: Unknown mode: " + lookingAt);
				}
				else
				{
