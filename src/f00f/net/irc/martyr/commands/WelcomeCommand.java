...
public class WelcomeCommand extends AbstractInCommand
{
    ...
    public WelcomeCommand( String nick, String notice )
    {
        this.notice = notice;
        this.nick = nick;
        ALS.alDebugPrint("WelcomeCommand: Nick is: `" + nick + "'");
        ALS.alDebugPrint("WelcomeCommand: Notice is: `"+notice+"'");
    }
    ...
    public InCommand parse( String prefix, String identifier, String params )
    {
        ...
        if( pi.hasNext() )
        {
            ALS.alDebugPrint("WelcomeCommand: More than two parameters, confused.");
        }
    ...
    {
        ALS.alDebugPrint("WelcomeCommand: updated client state with: " + new FullNick( nick ));
