...
public class ClientState
{
    ...
    public void setNick( FullNick nick )
    {
        if( nick == null )
        {
            ALS.alDebugPrint("ClientState: Set nick to null");
        }
        else
        {
            ALS.alDebugPrint("ClientState: Set nick to \"" + nick + "\"");
        }
        this.nick = nick;
    }
    ...
    {
        ALS.alDebugPrint("ClientState: Channel added: " + channel.getName());
    ...
    {
        ALS.alDebugPrint("ClientState: Channel removed: " + channel);
