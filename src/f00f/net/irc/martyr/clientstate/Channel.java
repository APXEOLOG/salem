...
public class Channel
{
	...
	{
		ALS.alDebugPrint(getName()+": Topic: " + topic);
		this.topic = topic;
	}
	...
	{
		ALS.alDebugPrint(getName()+": Topic date: " + date);
		this.topicDate = date;
	}
	...
	{
		ALS.alDebugPrint(getName()+": Creation date: " + date);
	...
	{
		ALS.alDebugPrint(getName()+": Topic by: " + author);
